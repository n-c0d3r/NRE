...
namespace nre {
	...
	class NRE_API F_png_texture_cube_asset_factory : public A_asset_factory {

	public:
		F_png_texture_cube_asset_factory();
		~F_png_texture_cube_asset_factory();

	public:
		NCPP_DISABLE_COPY(F_png_texture_cube_asset_factory);
