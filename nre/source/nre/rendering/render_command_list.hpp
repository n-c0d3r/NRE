...
namespace nre
{
	...
	NCPP_FHANDLE_TEMPLATE(render_command_list_handle, A_command_list)
	{
		...
		void draw_static_mesh(TKPA_valid<A_static_mesh> static_mesh_p);
	};
	...
	NCPP_FORCE_INLINE void TF_render_command_list_handle<F_oref__>::draw_static_mesh(TKPA_valid<A_static_mesh> static_mesh_p)
	{
		internal::H_render_command_list::draw_static_mesh(NCPP_KTHIS(), static_mesh_p);
	}
