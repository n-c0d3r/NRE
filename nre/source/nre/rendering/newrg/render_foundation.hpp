...
namespace nre::newrg
{
    ...
    private:
        ...
        F_render_foundation_rg_register_actor_data_event rg_register_render_actor_data_event_;
        F_render_foundation_rg_register_actor_data_upload_event rg_register_render_actor_data_upload_event_;
...
namespace nre::newrg::internal
{
    ...
    struct F_render_foundation_rg_register_actor_data_event_caller
    {
        template<typename F__>
        NCPP_FORCE_INLINE void operator = (F__&& functor) {

            F_render_foundation::instance_p()->T_get_event<F_render_foundation_rg_register_actor_data_event>().T_push_back_listener(
                std::forward<F__>(functor)
            );
        }
    };

    struct F_render_foundation_rg_register_actor_data_upload_event_caller
    {
        template<typename F__>
        NCPP_FORCE_INLINE void operator = (F__&& functor) {

            F_render_foundation::instance_p()->T_get_event<F_render_foundation_rg_register_actor_data_upload_event>().T_push_back_listener(
                std::forward<F__>(functor)
            );
        }
    };
...
#define NRE_NEWRG_RENDER_FOUNDATION_RG_REGISTER_ACTOR_DATA() \
    nre::newrg::internal::F_render_foundation_rg_register_actor_data_event_caller NCPP_GLUE(___nre_render_foundation_rg_register_actor_data_event___, NCPP_LINE); \
    NCPP_GLUE(___nre_render_foundation_rg_register_actor_data_event___, NCPP_LINE) = [&](auto&)
#define NRE_NEWRG_RENDER_FOUNDATION_RG_REGISTER_ACTOR_DATA_UPLOAD() \
    nre::newrg::internal::F_render_foundation_rg_register_actor_data_upload_event_caller NCPP_GLUE(___nre_render_foundation_rg_register_actor_data_upload_event___, NCPP_LINE); \
    NCPP_GLUE(___nre_render_foundation_rg_register_actor_data_upload_event___, NCPP_LINE) = [&](auto&)
