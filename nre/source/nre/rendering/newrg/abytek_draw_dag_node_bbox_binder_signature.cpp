...
namespace nre::newrg
{
    TK<F_abytek_draw_dag_node_bbox_binder_signature> F_abytek_draw_dag_node_bbox_binder_signature::instance_p_;



    F_abytek_draw_dag_node_bbox_binder_signature::F_abytek_draw_dag_node_bbox_binder_signature() :
        A_binder_signature(
            {
                .param_descs = {
                    F_root_param_desc(
            ...
            "NRE_NEWRG_ABYTEK_DRAW_DAG_NODE_BBOX_BINDER_SIGNATURE"
        )
    {
