...
namespace nre::newrg
{
    F_simple_abytek_drawable_material::F_simple_abytek_drawable_material(TKPA_valid<F_actor> actor_p, F_material_mask mask) :
        A_abytek_drawable_material(actor_p, mask)
    {
