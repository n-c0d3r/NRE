...
namespace nre::newrg
{
    TK<F_abytek_depth_prepass_binder_signature> F_abytek_depth_prepass_binder_signature::instance_p_;



    F_abytek_depth_prepass_binder_signature::F_abytek_depth_prepass_binder_signature() :
        A_binder_signature(
            {
                .param_descs = {
                    F_root_param_desc(
            ...
            "NRE_NEWRG_ABYTEK_DEPTH_PREPASS_BINDER_SIGNATURE"
        )
    {
