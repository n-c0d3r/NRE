...
namespace nre::newrg
{
    TK<F_abytek_draw_cluster_outer_error_sphere_binder_signature> F_abytek_draw_cluster_outer_error_sphere_binder_signature::instance_p_;



    F_abytek_draw_cluster_outer_error_sphere_binder_signature::F_abytek_draw_cluster_outer_error_sphere_binder_signature() :
        A_binder_signature(
            {
                .param_descs = {
                    F_root_param_desc(
            ...
            "NRE_NEWRG_ABYTEK_DRAW_CLUSTER_OUTER_ERROR_SPHERE_BINDER_SIGNATURE"
        )
    {
