...
namespace nre::newrg
{
    enum class E_render_pass_flag
    {
        ...
        GPU_ACCESS_RASTER = 0x4,
        GPU_ACCESS_RAY = 0x8,
        GPU_ACCESS_COMPUTE = 0x10,
        GPU_ACCESS_COPY = 0x20,
        ...
        MAIN_RENDER_WORKER = 0x80,
        ASYNC_COMPUTE_RENDER_WORKER = 0x100,

        CPU_SYNC_BEFORE_GPU = 0x200,
        CPU_SYNC_BEFORE_CPU = 0x400,
        CPU_SYNC_BEFORE = CPU_SYNC_BEFORE_GPU | CPU_SYNC_BEFORE_CPU,
        CPU_SYNC_AFTER_GPU = 0x800,
        CPU_SYNC_AFTER_CPU = 0x1000,
        CPU_SYNC_AFTER = CPU_SYNC_AFTER_GPU | CPU_SYNC_AFTER_CPU,
        CPU_SYNC = CPU_SYNC_BEFORE | CPU_SYNC_AFTER,

        PROLOGUE = MAIN_RENDER_WORKER | GPU_CPU_ACCESS_ALL | SENTINEL | NO_GPU_WORK, // internal use only
        EPILOGUE = MAIN_RENDER_WORKER | GPU_CPU_ACCESS_ALL | SENTINEL, // internal use only
