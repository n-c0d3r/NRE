...
namespace nre {
	...
	public:
		...
		NCPP_FORCE_INLINE F_render_view_mask mask() const noexcept {

			return 0;
		}
		NCPP_FORCE_INLINE F_render_view_mask mask(auto type_hash_code) const noexcept {
		...
		NCPP_FORCE_INLINE F_render_view_mask mask(auto type_hash_code_1, auto type_hash_code_2, auto... reset_type_hash_codes) const noexcept {
		...
		NCPP_FORCE_INLINE F_render_view_mask T_mask() const noexcept {
