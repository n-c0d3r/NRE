...
#define NRE_STATIC_MESH_DEFAULT_VERTEX_CHANNEL_INDEX_POSITION 0
#define NRE_STATIC_MESH_DEFAULT_VERTEX_CHANNEL_INDEX_NORMAL 1
#define NRE_STATIC_MESH_DEFAULT_VERTEX_CHANNEL_INDEX_TANGENT 2
#define NRE_STATIC_MESH_DEFAULT_VERTEX_CHANNEL_INDEX_TEXCOORD 3